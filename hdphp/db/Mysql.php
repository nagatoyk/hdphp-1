...
class Mysql
{
    ...
    {
        $field = $field=='*'?'*':"`$field`";
        $this->option['field']="count($field) AS c";
        $data = $this->first();
    ...
    {
        $this->option['field']="max(`$field`) AS m";
        $data = $this->first();
        return $data['m'];
    }
    ...
    {
        $this->option['field']="min(`$field`) AS m";
        $data = $this->first();
        return $data['m'];
    }
    ...
    {
        $this->option['field']="avg(`$field`) AS m";
        $data = $this->first();
        return $data['m'];
    }
    ...
    {
        $this->option['field']="sum(`$field`) AS m";
        $data = $this->first();
        return $data['m'];
    }
